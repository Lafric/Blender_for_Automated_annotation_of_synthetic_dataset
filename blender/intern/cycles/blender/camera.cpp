...
class BlenderCamera {
 public:
  ...
  float fisheye624_f = 0.0f;
  float fisheye624_cx = 0.0f;
  float fisheye624_cy = 0.0f;
  float fisheye624_k0 = 0.0f;
  float fisheye624_k1 = 0.0f;
  float fisheye624_k2 = 0.0f;
  float fisheye624_k3 = 0.0f;
  float fisheye624_k4 = 0.0f;
  float fisheye624_k5 = 0.0f;
  float fisheye624_p0 = 0.0f;
  float fisheye624_p1 = 0.0f;
  float fisheye624_s0 = 0.0f;
  float fisheye624_s1 = 0.0f;
  float fisheye624_s2 = 0.0f;
  float fisheye624_s3 = 0.0f;
